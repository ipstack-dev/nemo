...
public abstract class TlvAttribute {
	...
	public boolean equals(Object obj) {
		try {
			...
			if (a.type==type && a.len==len && Bytes.match(a.buf,a.off,a.len,buf,off,len)) return true;
			else return false;
		}
	...
	public String toString() {
		...
		sb.append("0x").append(Bytes.toHex(buf,off,len));
		sb.append('}');
		return sb.toString();
	}
