...
package io.ipstack.net.icmp6.message;
...
public class Icmp6RouterAdvertisementMessage extends Icmp6MessageWithOptions {
	...
	public Icmp6RouterAdvertisementMessage(Ip6Address src_addr, Ip6Address dst_addr, int hop_limit, boolean m_flag, boolean o_flag, int router_lifetime, long reachable_time, long retrans_timer, Icmp6Option[] options) {
		...
		Bytes.fromInt16(router_lifetime,icmp_body,2);
		Bytes.fromInt32(reachable_time,icmp_body,4);
		Bytes.fromInt32(retrans_timer,icmp_body,8);
	}
	...
	public int getRouterLifetime() {
		return Bytes.toInt16(icmp_body,2);
	}
	...
	public long getReachableTime() {
		return Bytes.toInt32(icmp_body,4);
	}
	...
	public long getRetransTimer() {
		return Bytes.toInt32(icmp_body,8);
	}

	@Override
	public String toString() {
		StringBuffer flags=new StringBuffer();
		if (getMFlag()) flags.append('M');
		if (getOFlag()) flags.append('O');
		return "ICMP "+src_addr+" > "+dst_addr+" Router advertisement flags="+flags;
	}
