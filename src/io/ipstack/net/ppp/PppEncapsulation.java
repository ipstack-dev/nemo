 ...
 */
public class PppEncapsulation extends DataPacket<Address> {
	...
	public int getBytes(byte[] buf, int off) {
		Bytes.fromInt16(protocol,buf,off);
	...
	public static PppEncapsulation parsePppEncapsulation(byte[] buf, int off, int len) {
		int protocol=Bytes.toInt16(buf,off);
	...
	public String toString() {
		//return "PPP encapsulation {protocol="+protocol+", datalen="+getPayloadLength()+", payload="+Bytes.toHex(getPayload())+"}";
