...
public class Ip4Address implements IpAddress {
	...
	/** Localhost address */
	public static final Ip4AddressPrefix ADDR_LOCALHOST=new Ip4AddressPrefix("127.0.0.1/8");
	...
	public boolean isLoopback() {
		return ADDR_LOCALHOST.equals(this) || Ip4Prefix.PREFIX_LOOPBACK.contains(this);
	}
