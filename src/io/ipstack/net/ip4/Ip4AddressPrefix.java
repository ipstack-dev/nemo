...
public class Ip4AddressPrefix extends Ip4Address implements IpAddressPrefix {
	...
	/** Whether this is a directed broadcast address.
	 * @return <i>true</i> if directed broadcast address */
	public boolean isDirectedBradcastAddress() {
		return getPrefix().getDirectedBroadcastAddress().equals(this);
	}
	...
	public byte[] getPrefixMask() {
		return IpAddressUtils.prefixLengthToIp4Mask(prefix_len);
	}
