 ...
 * <p>
 *  it is implemented directly on top of the {@link io.ipstack.net.ip4.Ip4Layer}
		...
		this_ip_listener=new Ip4LayerListener() {
			...
			public void onReceivedPacket(Ip4Layer ip_layer, Ip4Packet ip_pkt) {
				...
				if (icmp_msg.getSourceAddress().equals(target_ip_addr) && icmp_msg.getType()==IcmpMessage.TYPE_Echo_Reply) {
					...
					//DefaultLogger.log(LoggerLevel.DEBUG,"Ping: ICMP Echo reply: id="+icmp_echo_reply.getIdentifier()+" sqn="+icmp_echo_reply.getSequenceNumber());
