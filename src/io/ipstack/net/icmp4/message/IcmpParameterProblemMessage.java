...
public class IcmpParameterProblemMessage extends IcmpMessageWithDatagram {
	...
	public IcmpParameterProblemMessage(Ip4Address src_addr, Ip4Address dst_addr, int code, int pointer, Ip4Packet ip_packet) {
	...
	public IcmpParameterProblemMessage(Ip4Address src_addr, Ip4Address dst_addr, byte[] buf, int off, int len) {
	...
	public String toString() {
		return "ICMP "+src_addr+" > "+dst_addr+" Parameter problem code="+code+" pointer="+getPointer();
	}
