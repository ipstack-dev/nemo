...
abstract class IcmpMessageWithDatagram extends IcmpMessage {
	...
	protected IcmpMessageWithDatagram(Ip4Address src_addr, Ip4Address dst_addr, int type, int code, Ip4Packet ip_datagram) {
	...
	/*protected IcmpMessageWithDatagram(Ip4Address src_addr, Ip4Address dst_addr, int type, int code, byte[] datagram_buf, int datagram_off, int datagram_len) {
		super(src_addr,dst_addr,type,code);
	...
	protected IcmpMessageWithDatagram(Ip4Address src_addr, Ip4Address dst_addr, byte[] buf, int off, int len) {
