...
public class IcmpRedirectMessage extends IcmpMessageWithDatagram {
	...
	public IcmpRedirectMessage(Ip4Address src_addr, Ip4Address dst_addr, int code, Ip4Address gateway, Ip4Packet ip_packet) {
	...
	public IcmpRedirectMessage(Ip4Address src_addr, Ip4Address dst_addr, byte[] buf, int off, int len) {
	...
	public String toString() {
		return "ICMP "+src_addr+" > "+dst_addr+" Redirect code="+code+" gateway="+getPointer();
	}
