...
public class IcmpSourceQuenchMessage extends IcmpMessageWithDatagram {
	...
	public IcmpSourceQuenchMessage(Ip4Address src_addr, Ip4Address dst_addr, int code, Ip4Packet ip_packet) {
	...
	public IcmpSourceQuenchMessage(Ip4Address src_addr, Ip4Address dst_addr, byte[] buf, int off, int len) {
	...
	public String toString() {
		return "ICMP "+src_addr+" > "+dst_addr+" Source quench";
	}
