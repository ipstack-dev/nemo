...
abstract class IcmpEchoMessage extends IcmpMessage {
	...
	protected IcmpEchoMessage(Ip4Address src_addr, Ip4Address dst_addr, int type, int id, int sqn, byte[] echo_data) {
		...
		Bytes.fromInt16(id,icmp_body,0);
		Bytes.fromInt16(sqn,icmp_body,2);
	...
	protected IcmpEchoMessage(Ip4Address src_addr, Ip4Address dst_addr, byte[] buf, int off, int len) {
	...
	public int getIdentifier() {
		return Bytes.toInt16(icmp_body,0);
	}
