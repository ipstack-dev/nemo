...
public class IcmpTimeExceededMessage extends IcmpMessageWithDatagram {
	...
	public IcmpTimeExceededMessage(Ip4Address src_addr, Ip4Address dst_addr, int code, Ip4Packet ip_packet) {
	...
	public IcmpTimeExceededMessage(Ip4Address src_addr, Ip4Address dst_addr, byte[] buf, int off, int len) {
	...
	public String toString() {
		return "ICMP "+src_addr+" > "+dst_addr+" Time exceeded "+(code==CODE_time_to_live_exceeded_in_transit?"in transit":", fragment reassembly time exceeded");
	}
