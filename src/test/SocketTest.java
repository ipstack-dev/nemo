...
public class SocketTest {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		int srv_port=flags.getInteger("-s",-1,"<port>","runs an echo server on the selected port");
		String dst_soaddr=flags.getString("-d",null,"<dest-soaddr>","sends a message to the selected remote address");
		MESSAGE=flags.getString("-m","hello","<message>","sends the selected message");
