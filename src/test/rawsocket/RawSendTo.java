...
/** Program for sending raw IP packets.
  ...
  * </pre>
  */
public abstract class RawSendTo {
	...
	public static void main(String[] args) {
		...
		String dst_addr=flags.getString(null,null,"<daddr>","destination address");
		//String src_addr="0.0.0.0";
		int proto=flags.getInteger(null,-1,"<proto>","protocol number");
		boolean verbose=flags.getBoolean("-v","verbode mode");
		String file=flags.getString("-f",null,"<file>","sends data from the given file");
		String data_str=flags.getString("-a",null,"<data>","sends the given text data");
		...
		String options_str=flags.getString("-o",null,"<options>","sets the given IP options (in hexadecimal format)");
		int version=flags.getBoolean("-6","uses IPv6")? 6:4;
		int millisec=flags.getInteger("-t",0,"<millisec>","loops sending the same packet every given millisecs");
