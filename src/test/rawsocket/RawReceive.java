...
/** Program for receiving raw IP packets.
  ...
  */
public abstract class RawReceive {
	...
	public static void main(String[] args) {
		...
		String file=flags.getString("-f",null,"<file>","write data to the given file");
		...
		int count=flags.getInteger("-c",1,"<count>","stop after received a given number of packets ('-1' for continue mode)");
