...
public class TestNetworkFactory {
	...
	public static Network<Ip4Node,Link<Ip4Address,Ip4Packet>> getInstance(Link<Ip4Address,Ip4Packet> gw_link, HashMap<String,String> auth_db0, TestNetworkInfo cfg) {
		Network<Ip4Node,Link<Ip4Address,Ip4Packet>> network=new Network<Ip4Node,Link<Ip4Address,Ip4Packet>>() {
			...
			Link<Ip4Address,Ip4Packet> saved_gw_link=gw_link;
		...
		build(network,gw_link,auth_db0,cfg);
		return network;
	}
	...
	private static void build(Network<Ip4Node,Link<Ip4Address,Ip4Packet>> network, Link<Ip4Address,Ip4Packet> gw_link, HashMap<String,String> auth_db0, TestNetworkInfo cfg) {		
		...
		if (gw_link!=null) {
			NetInterface<Ip4Address, Ip4Packet> r0_ni1=new LinkInterface<>(gw_link,new Ip4AddressPrefix("10.255.0.1/24"));
			NetInterface<Ip4Address,Ip4Packet> r0_ni2=new LinkInterface<>(link0,new Ip4AddressPrefix("10.0.0.254/24"));
			Ip4Router r0=new Ip4Router(new Ip4Address(cfg.loopback_addr_prefix+0+'.'+254),r0_ni1,r0_ni2);
			r0.getRoutingTable().set(Ip4Prefix.ANY,new Ip4Address("10.255.0.254"));
