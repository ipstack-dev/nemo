...
import io.ipstack.net.ethernet.EthSwitch;
...
public abstract class LanTest {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		long interTime= flags.getLong("-t",0,"msecs","the starts of the servers are delayed by this inter-time [ms]");
		...
		for (int i= 0; i<n; i++) {
			if (i>0 && interTime>0) Thread.sleep(interTime);
