...
public abstract class PingServer {
	...
	public static void main(String[] args) throws IOException {
		...
		ip_addr=new Ip4Address(flags.getString("-a",ip_addr.toString(),"<ipaddr>","IP address that is resolved by ARP on TAP interface"));
		String tunap_interface=flags.getString(null,null,"<tuntap>","TUN/TAP interface (e.g. 'tun0')");
