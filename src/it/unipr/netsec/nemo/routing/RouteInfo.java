...
public class RouteInfo {
	...
	public RouteInfo(NetAddress dest, Address next_hop, Address interface_addr, int cost) {
		this(dest.toString(),next_hop!=null?next_hop.toString():null,interface_addr.toString(),cost);
	}
