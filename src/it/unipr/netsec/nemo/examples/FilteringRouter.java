...
public class FilteringRouter extends Ip4Router {
	...
	public FilteringRouter(IpLink<Ip4Address,Ip4Packet>[] ip_links, Action default_policy) {
		super(ip_links);
	...
	public FilteringRouter(NetInterface<Ip4Address,Ip4Packet>[] net_interfaces, Action default_policy) {
	...
	protected void processForwardingPacket(Ip4Packet ip_pkt) {
		...
		if (accept) super.processForwardingPacket(ip_pkt);
		else {
			printLog("packet dropped: "+ip_pkt.toString());
		}	
	}
