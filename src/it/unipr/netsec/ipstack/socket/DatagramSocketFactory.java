...
public abstract class DatagramSocketFactory {
	...
	public static DatagramSocket getInstance() throws SocketException {
		return FACTORY!=null? FACTORY.createInstance() : new JavanetDatagramSocket();
	}
	...
	public static DatagramSocket getInstance(int port) throws SocketException {
		return FACTORY!=null? FACTORY.createInstance(port) : new JavanetDatagramSocket(port);
	}

	/** Creates a new UDP socket. 
	 * @return the new socket
	 * @throws SocketException */
	public abstract DatagramSocket createInstance() throws SocketException;

	/** Creates a new UDP socket. 
	 * @param port the UDP port
	 * @return the new socket
	 * @throws SocketException */
	public abstract DatagramSocket createInstance(int port) throws SocketException;
