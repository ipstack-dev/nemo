...
public class DatagramSocket extends it.unipr.netsec.ipstack.udp.DatagramSocket {
	...
	public DatagramSocket() throws SocketException {
		super(IpStack.getDefaultInstance().getUdpLayer());
	}
	...
	public DatagramSocket(int port) throws SocketException {
		super(IpStack.getDefaultInstance().getUdpLayer(),port);
	}

	/** Creates a datagram socket, bound to the specified local address. */
	public DatagramSocket(int port, InetAddress laddr) throws SocketException {
		super(IpStack.getDefaultInstance().getUdpLayer(),port,laddr);
	}

	/** Creates a datagram socket, bound to the specified local socket address. */
	public DatagramSocket(SocketAddress bindaddr) throws SocketException {
		super(IpStack.getDefaultInstance().getUdpLayer(),bindaddr);
	}
