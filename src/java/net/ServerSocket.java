...
public class ServerSocket extends it.unipr.netsec.ipstack.tcp.ServerSocket {
	...
	public ServerSocket(int port) throws IOException {
		super(IpStack.getDefaultInstance().getTcpLayer(),port);
	}

	/** Creates a server socket and binds it to the specified local port number, with the specified backlog. */
	public ServerSocket(int port, int backlog) throws IOException {
		super(IpStack.getDefaultInstance().getTcpLayer(),port,backlog);
	}

	/** Create a server with the specified port, listen backlog, and local IP address to bind to. */
	public ServerSocket(int port, int backlog, InetAddress bindAddr) throws IOException {
		super(IpStack.getDefaultInstance().getTcpLayer(),port,backlog,bindAddr);
	}
